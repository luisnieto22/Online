...
if(isset($aceptar)){
	...
	$q = $mysqli->query("SELECT * FROM productos_compra WHERE id_compra = '$id_compra'");
	
	while($r=mysqli_fetch_array($q)){

		$mysqli->query("UPDATE productos SET instock = instock - '".$r['cantidad']."' WHERE id = '".$r['id_producto']."'");
